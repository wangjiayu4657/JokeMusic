    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (ctx, idx) {
          if(idx == 1 || idx == 3) return Divider(color: ColorExtension.hex("#F7F7F7"),thickness: 12.px);
          return const Divider(color: Colors.transparent, height: 0.1,);
        },
      ),
    );
  }
  ...
  Widget buildListHeader() {
    return Column(
      ...
      children: [
        ...
        buildListHeaderInfo(),
        Divider(color: ColorExtension.lineColor,thickness: 12.px),
